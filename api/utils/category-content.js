...
const categoryInfo = {
  "manufacturing": {
    ...
    structuredData: {
      collectionPage: {
        ...
        "description": "Interactive directory of manufacturing facilities with documented asbestos exposure across the United States",
        ...
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
            "name": "National Manufacturing Facilities",
            "item": {
              "@type": "Thing",
              "name": "Major facilities available through state selection",
  ...
  "shipyards": {
    ...
    metaKeywords: "shipyard asbestos exposure, navy ships asbestos, naval shipyard mesothelioma, maritime asbestos, veteran asbestos exposure",
    ...
    structuredData: {
      collectionPage: {
        ...
        "description": "Interactive directory of major shipyards with documented asbestos exposure across the United States",
        ...
        "hasPart": [
          ...
          },
          {
            "@type": "WebPageElement",
            "name": "Industries Affected Section",
            "description": "Comprehensive list of shipyard industries and occupations affected by asbestos exposure"
          },
          {
            "@type": "WebPageElement",
            "name": "Legal Action Center",
            "description": "Resources and guidance for veterans, workers and families seeking compensation"
          }
        ],
        "potentialAction": {
          "@type": "SearchAction",
        ...
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
            "name": "National Shipyards",
            "item": {
              "@type": "Thing",
              "name": "Major shipyards available through state selection",
      ...
      medicalWebPage: {
        "@context": "https://schema.org",
        "@type": "MedicalWebPage",
        "name": "Shipyard Asbestos Exposure Health Information",
        "about": {
          "@type": "MedicalCondition",
          "name": "Asbestos-Related Diseases",
          "alternateName": ["Mesothelioma", "Asbestosis", "Lung Cancer"],
          ...
          "riskFactor": [
            {
              "@type": "MedicalRiskFactor",
              "name": "Occupational Asbestos Exposure in Shipyards"
            }
          ]
        },
        "medicalAudience": {
          ...
          "healthCondition": {
            "@type": "MedicalCondition",
            "name": "At risk for asbestos-related diseases from shipyard exposure"
          }
        },
        "aspect": ["Cause", "Prevention", "Prognosis", "Treatment"]
      },
      faqPage: {
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "name": "Shipyard Asbestos Exposure FAQs",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What percentage of mesothelioma cases are linked to shipyard exposure?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Over 33% of all mesothelioma cases have been linked to U.S. Navy ships or shipyards, representing the largest single source of occupational asbestos exposure in the United States."
            }
          },
          {
            "@type": "Question",
            "name": "Are Navy veterans eligible for VA benefits for asbestos exposure?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes, U.S. Navy veterans diagnosed with mesothelioma typically receive a 100% disability rating from the VA, providing maximum monthly compensation averaging nearly $4,000 for married veterans as of 2025."
            }
          },
          {
            "@type": "Question",
            "name": "Can family members of shipyard workers file asbestos claims?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes, family members who developed asbestos-related diseases from secondary exposure or who lost loved ones may file wrongful death claims and seek compensation for medical expenses and other damages."
            }
          }
        ]
      }
